...
users.forEach(({first_name, last_name, age, email, avatar, progress}) => {
  ...
  cardElem.style.background = age >= 18 && first_name[0].toLowerCase() === 'a' ? 'linear-gradient(90deg, rgba(200,154,252,1) 0%, rgba(124,106,250,0.30438112745098034) 62%)' : 'lightblue';
